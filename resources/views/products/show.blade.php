                ...
                <div class="card-body product-info">
                    <div class="row">
                        ...
                        <div class="col-7">
                            ...
                            <!-- 众筹商品模块开始 -->
                            @if($product->type === \App\Http\Models\Enum\ProductEnum::TYPE_CROWDFUNDING)
                                <div class="crowdfunding-info">
                                    ...
                                    <!-- 如果众筹状态是众筹中，则输出提示语 -->
                                    @if ($product->crowdfunding->status === \App\Http\Models\Enum\CrowdfundingProductEnum::STATUS_FUNDING)
                                        <div>此项目必须在
                                        ...
                                        @if(Auth::check())
                                            ...
                                            @else
                                                <button class="btn btn-primary disabled">
                                                    {{ \App\Http\Models\Enum\CrowdfundingProductEnum::$statusMap[$product->crowdfunding->status] }}
                                                </button>
                                            @endif
                                        @else
